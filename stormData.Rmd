...
## 3.Results
Table.@ is a list of top 5 weather events which caused the most fatalities and injuries on US citizens from 1993 to 2011. (see full list for appendix @).Figure.** is the plot the total number of fatalities and injuries by year for each top 5 weather event.  
...
healthDmgSum <- data %>% 
  ...
  arrange(desc(Total)) 
Rank <- 1:5
kbl(cbind(Rank,healthDmgSum[1:5,]), caption='Top 5 events Caused Most Fatalities/Injuries (Descending order of Total)',
             type='html')  %>% 
...
1. TORNADO  
TORNADO has the highest figure of fatalities and injuries in the records. From 1993, mostly keep the highest place, and 2011 was the one of the worst year, 88% of the total fatalities/injuries in this year were caused by TORNADO.  
